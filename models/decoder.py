    ...
    def __init__(self, decoder_config={}):
        ...
        if decoder_config['use_graph'] == True:
            ...
            if len(decoder_config['c2ind']) == 50:
                edges_dict = pickle.load(open('/data1/BXL/mimic_ICD/ICDNEW/mimicdata/{}/50_relation.pkl'.format(MIMIC_DIR), 'rb'))
            else:
                edges_dict = pickle.load(open('/data1/BXL/mimic_ICD/ICDNEW/mimicdata/{}/full_relation.pkl'.format(MIMIC_DIR), 'rb'))
